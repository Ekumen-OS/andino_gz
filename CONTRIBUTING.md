...
The following is a set of guidelines for contributing to andino_gz project.
...
* **Are you running andino_gz using the provided docker container?** See [docker](docker/README.md).
...
* **Perform a** [cursory search](https://github.com/Ekumen-OS/andino_gz/issues?q=is%3Aissue) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
#. **Fork the andino_gz package** you want to contribute to. This will create
