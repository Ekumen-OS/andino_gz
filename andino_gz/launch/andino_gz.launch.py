...
def generate_launch_description():
    ...
    robots_arg = DeclareLaunchArgument('robots', default_value="andino={x: 0., y: 0., z: 0.1, yaw: 0.};", description='Robots to spawn, multiple robots can be stated separated by a ; ')
    ...
    for robot_name in robots_list:
        ...
        group = GroupAction([
          ...
          PushRosNamespace(condition=IfCondition(PythonExpression([TextSubstitution(text=str(len(robots_list.keys()))), ' > 1'])), namespace=robot_name),
